...
return [
    'modules' => [
        ...
        'Eglobe_AppendSiteName' => 0,
        'Eglobe_CategoryImage' => 1,
        'Eglobe_CronJob' => 0,
        'Eglobe_FailedLogin' => 0,
        'Eglobe_NotFoundPages' => 0,
        'Eglobe_OutofstockCronjob' => 0,
        'Eglobe_PageNotFound' => 0,
        'Eglobe_SampleBlock' => 0,
        'Eglobe_ShopCartModule' => 1,
        'Eglobe_StoreModule' => 1,
        'Eglobe_TestModule' => 0,
        'Klarna_Core' => 1,
